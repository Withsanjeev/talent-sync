...
<body>
    <style>
        ...
        .bg-darkgray {
            background-color:rgb(178, 201, 225) !important;
        }
    </style>
    <!--navbar-->
    <nav class="navbar navbar-expand-lg bg-white fixed-top">
        <div class="container">
        <a class="navbar-brand" href="#" style="font-size: 32px; font-weight: bold; text-decoration: none;">
    <span style="color: black;">Talent</span>
    <span style="color: red;">Sync</span>
</a>

        <a class="navbar-brand" href="#">Finding Quality jobs </a>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="first-slide img-fluid w-100 " src="./img/aabb.jpg" alt="First slide">
                <div class="container">
                    <div class="carousel-caption text-left" tyle="color: blue;">
                    <h1>
    <img class="img-fluid mt-3" src="img/logo.png" height="500px" width="300px" alt="Talent Sync" />
</h1>
    ...
    <div class="container marketing p-3">
        ...
        <div class="row mt-4">
            <div class="col-lg-4" style="text-align: center;">
                <img class="rounded mb-2" src="./img/book.png" alt="Generic placeholder image" width="140"
                    height="140">
                <h2 class="text-center ">Find Your Job Easier</h2>
                <p class="text-center">At Talent sync, we understand that finding the right job can be a challenging
            ...
            <div class="col-lg-4" style="text-align: center;">
                <img class="rounded mb-2" src="./img/saas.png" alt="Generic placeholder image" width="140"
                    height="140">
            ...
            <div class="col-lg-4" style="text-align: center;">
                <img class="rounded mb-2" src="./img/trust.png" alt="Generic placeholder image" width="140"
                    height="140">
            ...
            <div class="col-md-7 d-flex align-items-center justify-content-cente">
                <div>
                    <h2 class="featurette-heading">Our Story : <span class="text-muted">Driven by Passion and
                            Purpose.</span></h2>
                    <p class="lead"> Talent sync was born out of a passion for connecting talented individuals with
    ...
    <footer class="bg-white p-4 text-muted ">
        <div class="container">
            ...
            <div class="d-flex flex-column align-items-center justify-content-cente mt-3">
                ...
                <!--copyrights-->
                <div class="d-flex">
                    <a class=" " href="#"><img src="img/logo.png" width="58px" height="16px" alt="talent sync"
                            class="mb-2" /></a>
