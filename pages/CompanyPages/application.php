...
-->
    ...
    <head>
        ...
        <title>Talentsync | Company </title>
        <!--bootstrap-->
                ...
                <div class="justify-content-center ">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            ...
                            <span class="fs-4">
                        <span style="color: black; font-weight: bold;">Quality </span>
                         <span style="color: red; font-weight: bold;">Jobs</span>
                           </span>
                        </li>
                    </ul>
                </div>
                ...
                <div class=" h-100 fixed-top overflow-hidden" style="padding-top: 56px;min-width: 10rem;max-width: 12rem;z-index: 4">
                    ...
                    <div class="d-flex flex-column flex-shrink-0 p-3 d-none d-lg-block vh-100 bg-white " style="max-width: 20rem">
                        <a href="../../index.php" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
                            <img src="../../img/logo.png" height="43px" alt="Talentsync" />
                    ...
                    <div class="d-flex flex-column flex-shrink-0 bg-white d-lg-none d-block  vh-100" style="width: 4.5rem;">
                        <a href="../../index.php" class="d-block p-3 link-body-emphasis text-decoration-none" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="talent sync">
                            <img src="../../img/logo only.png" height="43px" alt="Finding quality jobs" />
