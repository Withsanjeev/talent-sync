    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
            <div class="container">
                ...
                <a class="navbar-brand " href="../../index.php"><img src="../../img/logo.png" width="100px" height="43px"
                        alt="Talent sync" /></a>

                        <span style="font-weight: bold; color: black; font-size: 36px;">Finding Quality </span>
               <span style="font-weight: bold;color: red; font-size: 36px;">Jobs</span>
              </a>
                                ...
                                <div class="d-flex flex-column align-items-center justify-content-cente mt-4">
                                    ...
                                    <div class="d-flex">
                                        <a class=" " href="../../index.php"><img src="../../img/logo.png" width="58px"
                                                height="16px" alt="Talent sync" class="mb-2" /></a>
