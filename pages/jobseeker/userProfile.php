    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
            <div class="container">
                ...
                <a class="navbar-brand " href="../../index.php"><img src="../../img/logo.png" width="90px" height="60px"
                        alt="Talentsync" /></a>
                                ...
                                <div class="d-flex flex-column align-items-center justify-content-cente mt-4">
                                    ...
                                    <div class="d-flex">
                                        <a class=" " href="../../index.php"><img src="../../img/logo.png" width="58px"
                                                height="16px" alt="Talentsync" class="mb-2" /></a>
                        ...
                        <div class="">
                            ...
                            try {
                                ...
                                <div class="d-flex flex-column align-items-center justify-content-cente mt-2">
                                    ...
                                    <div class="d-flex">
                                        <a class=" " href="../../index.php"><img src="../../img/logo.png" width="58px"
                                                height="16px" alt="Talentsynct" class="mb-2" /></a>
                                        <p class="fs-7">&copy; 2023</p>
                                    </div>
                                </div>
